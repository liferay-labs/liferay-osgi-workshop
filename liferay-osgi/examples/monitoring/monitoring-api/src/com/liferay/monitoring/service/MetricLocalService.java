...
/**
 * Provides the local service interface for Metric. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MetricLocalServiceUtil
...
public interface MetricLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MetricLocalServiceUtil} to access the metric local service. Add custom service methods to {@link com.liferay.monitoring.service.impl.MetricLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
