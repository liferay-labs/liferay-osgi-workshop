...
@Component(
	...
	property = {
		"javax.portlet.name=com_liferay_monitoring_web_portlet_MetricsPortlet"
	},
	service = ConfigurationAction.class
)
public class MonitoringConfigurationAction
	...
	public void processAction(
		...
		String frequency = getParameter(actionRequest, "frequency");

		setPreference(actionRequest, "frequency", frequency);
	...
	private volatile MonitoringConfiguration _amazonRankingsConfiguration;
